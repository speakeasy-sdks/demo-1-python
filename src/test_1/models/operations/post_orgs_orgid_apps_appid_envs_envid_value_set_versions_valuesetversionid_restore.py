...
class PostOrgsOrgIDAppsAppIDEnvsEnvIDValueSetVersionsValueSetVersionIDRestoreRequest:
...
@dataclasses.dataclass
class PostOrgsOrgIDAppsAppIDEnvsEnvIDValueSetVersionsValueSetVersionIDRestoreResponse:
    ...
    r"""No ValueSetVersion with `valueSetVersionId` in App Environment."""
    ...
    r"""The resulting ValueSetVersion"""
