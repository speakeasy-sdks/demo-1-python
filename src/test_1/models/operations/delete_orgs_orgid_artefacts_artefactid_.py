...
class DeleteOrgsOrgIDArtefactsArtefactIDRequest:
...
@dataclasses.dataclass
class DeleteOrgsOrgIDArtefactsArtefactIDResponse:
    ...
    r"""Request forbidden. This action can only be performed by users holding the Administrator role. It is not possible to delete a built-in artefact."""
