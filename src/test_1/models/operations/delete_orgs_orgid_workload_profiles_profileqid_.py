...
class DeleteOrgsOrgIDWorkloadProfilesProfileQidRequest:
...
@dataclasses.dataclass
class DeleteOrgsOrgIDWorkloadProfilesProfileQidResponse:
    ...
    r"""The Workload Profile is not found or is not accessible by the organization."""
