        ...
        shared.DeltaRequest(
            ...
            modules=shared.ModuleDeltasRequest(
                add={
                    ...
                    "quas": {
                        "aperiam": shared.ControllerRequest(
                            kind='itaque',
                            message='quaerat',
                            pods=[
                                shared.PodStateRequest(
...
res = s.public.patch_orgs_org_id_apps_app_id_deltas_delta_id_(req)
...
res = s.public.patch_orgs_org_id_apps_app_id_envs_env_id_runtime_replicas(req)
...
res = s.public.patch_orgs_org_id_apps_app_id_envs_env_id_values_key_(req)
...
res = s.public.patch_orgs_org_id_apps_app_id_users_user_id_(req)
...
res = s.public.patch_orgs_org_id_apps_app_id_values_key_(req)
...
res = s.public.patch_orgs_org_id_artefacts_artefact_id_versions_version_id_(req)
...
res = s.public.patch_orgs_org_id_env_types_env_type_users_user_id_(req)
...
req = operations.PatchOrgsOrgIDRegistriesRegIDRequest(
    registry_request=shared.RegistryRequest(
        creds=shared.AccountCredsRequest(
            ...
            password='quisquam',
            username='Jarrett_OConnell43',
        ),
        enable_ci=False,
        id='16ea5c71-6419-434b-90f2-e09d19d2fc2f',
        registry='natus',
        secrets={
            "fugit": shared.ClusterSecretRequest(
                namespace='repudiandae',
                secret='vitae',
            ),
            "consequatur": shared.ClusterSecretRequest(
                namespace='nemo',
                secret='provident',
            ),
            "numquam": shared.ClusterSecretRequest(
                namespace='numquam',
                secret='tempore',
            ),
            "molestias": shared.ClusterSecretRequest(
                namespace='amet',
                secret='enim',
            ),
        },
...
res = s.public.patch_orgs_org_id_registries_reg_id_(req)
...
req = operations.PatchOrgsOrgIDResourcesAccountsAccIDRequest(
    update_resource_account_request_request=shared.UpdateResourceAccountRequestRequest(
        ...
        name='Anthony Labadie',
    ),
    acc_id='fugiat',
    org_id='laboriosam',
)

res = s.public.patch_orgs_org_id_resources_accounts_acc_id_(req)
...
res = s.public.patch_orgs_org_id_resources_defs_def_id_(req)
...
res = s.public.patch_orgs_org_id_users_user_id_(req)
...
req = operations.PostOrgsOrgIDAppsRequest(
    application_creation_request=shared.ApplicationCreationRequest(
        ...
        id='001e22cd-55cc-4058-8a18-4d76d971fc82',
        name='Sheri Johns',
    ),
    org_id='aut',
)

res = s.public.post_orgs_org_id_apps(req)
...
req = operations.PostOrgsOrgIDAppsAppIDDeltasRequest(
    delta_request=shared.DeltaRequest(
        id='37bb8e0c-c885-4187-a4de-04af28c5dddb',
        metadata=shared.DeltaMetadataRequest(
            archived=False,
            contributers=[
                'commodi',
        ...
        modules=shared.ModuleDeltasRequest(
            add={
                "magni": {
                    "assumenda": shared.ControllerRequest(
                        kind='culpa',
                        message='ipsa',
                        pods=[
                            shared.PodStateRequest(
                    ...
                    "quaerat": shared.ControllerRequest(
                        kind='enim',
                        message='cumque',
                        pods=[
                            shared.PodStateRequest(
                ...
                "numquam": {
                    "repellendus": shared.ControllerRequest(
                        kind='blanditiis',
                        message='ut',
                        pods=[
                            shared.PodStateRequest(
                ...
                "temporibus": {
                    "itaque": shared.ControllerRequest(
                        kind='nulla',
                        message='excepturi',
                        pods=[
                            shared.PodStateRequest(
...
res = s.public.post_orgs_org_id_apps_app_id_deltas(req)
...
res = s.public.post_orgs_org_id_apps_app_id_envs(req)
...
res = s.public.post_orgs_org_id_apps_app_id_envs_env_id_deploys(req)
...
res = s.public.post_orgs_org_id_apps_app_id_envs_env_id_rules(req)
...
req = operations.PostOrgsOrgIDAppsAppIDEnvsEnvIDValueSetVersionsValueSetVersionIDPurgeKeyRequest(
    ...
    key='magni',
    org_id='sit',
    value_set_version_id='53b74936-6ac8-4ee0-b2bf-19588d40d03f',
)

res = s.public.post_orgs_org_id_apps_app_id_envs_env_id_value_set_versions_value_set_version_id_purge_key_(req)
...
req = operations.PostOrgsOrgIDAppsAppIDEnvsEnvIDValueSetVersionsValueSetVersionIDRestoreRequest(
    ...
    env_id='saepe',
    org_id='nobis',
    value_set_version_id='a297be3e-90bc-440d-b868-fd52405cb331',
)

res = s.public.post_orgs_org_id_apps_app_id_envs_env_id_value_set_versions_value_set_version_id_restore(req)
...
req = operations.PostOrgsOrgIDAppsAppIDEnvsEnvIDValueSetVersionsValueSetVersionIDRestoreKeyRequest(
    ...
    key='quia',
    org_id='reiciendis',
    value_set_version_id='4f127fb0-e0bf-41f8-a179-78d0acca77ae',
)

res = s.public.post_orgs_org_id_apps_app_id_envs_env_id_value_set_versions_value_set_version_id_restore_key_(req)
...
res = s.public.post_orgs_org_id_apps_app_id_envs_env_id_values(req)
...
req = operations.PostOrgsOrgIDAppsAppIDSetsSetIDRequest(
    delta_request=shared.DeltaRequest(
        ...
        modules=shared.ModuleDeltasRequest(
            add={
                "rerum": {
                    "sapiente": shared.ControllerRequest(
                        kind='recusandae',
                    ...
                    "veritatis": shared.ControllerRequest(
                        kind='molestias',
                        message='impedit',
                        pods=[
                            shared.PodStateRequest(
...
res = s.public.post_orgs_org_id_apps_app_id_sets_set_id_(req)
...
req = operations.PostOrgsOrgIDAppsAppIDUsersRequest(
    user_role_request=shared.UserRoleRequest(
        created_at='2020-06-22T09:37:23.523Z',
        email='Elvera.Douglas@yahoo.com',
        id='e060459b-ebba-4d02-b258-6bcf152558da',
        invite='fuga',
        name='Lewis Reichert',
        role='porro',
        type='nulla',
...
res = s.public.post_orgs_org_id_apps_app_id_users(req)
...
req = operations.PostOrgsOrgIDAppsAppIDValueSetVersionsValueSetVersionIDPurgeKeyRequest(
    ...
    key='impedit',
    org_id='consectetur',
    value_set_version_id='54aa432b-47e1-4763-8520-8c23e9802d82',
)

res = s.public.post_orgs_org_id_apps_app_id_value_set_versions_value_set_version_id_purge_key_(req)
...
req = operations.PostOrgsOrgIDAppsAppIDValueSetVersionsValueSetVersionIDRestoreRequest(
    ...
    app_id='alias',
    org_id='repellendus',
    value_set_version_id='45eb4a8b-674e-4e5c-bc18-edc7f787e32e',
)

res = s.public.post_orgs_org_id_apps_app_id_value_set_versions_value_set_version_id_restore(req)
...
req = operations.PostOrgsOrgIDAppsAppIDValueSetVersionsValueSetVersionIDRestoreKeyRequest(
    ...
    key='rerum',
    org_id='nesciunt',
    value_set_version_id='d3ed0c56-70ef-442b-93c9-f1cc503f6c39',
)

res = s.public.post_orgs_org_id_apps_app_id_value_set_versions_value_set_version_id_restore_key_(req)
...
res = s.public.post_orgs_org_id_apps_app_id_values(req)
...
req = operations.PostOrgsOrgIDAppsAppIDWebhooksRequest(
    webhook_request=shared.WebhookRequest(
        ...
        id='957f3851-89ad-47ef-807a-ae03f33ca79f',
        payload={
            "provident": 'fugiat',
            "recusandae": 'non',
            "aut": 'neque',
...
res = s.public.post_orgs_org_id_apps_app_id_webhooks(req)
...
req = operations.PostOrgsOrgIDAppsAppIDWebhooksJobIDRequest(
    ...
    app_id='reprehenderit',
    job_id='minus',
    org_id='non',
)

res = s.public.post_orgs_org_id_apps_app_id_webhooks_job_id_(req)
...
res = s.public.post_orgs_org_id_artefact_versions(req)
...
req = operations.PostOrgsOrgIDEnvTypesRequest(
    environment_type_request=shared.EnvironmentTypeRequest(
        description='minima',
        id='c5dbb3c5-7c1e-4498-9e8a-a257ddc1912e',
    ),
    org_id='quidem',
)

res = s.public.post_orgs_org_id_env_types(req)
...
req = operations.PostOrgsOrgIDEnvTypesEnvTypeUsersRequest(
    user_role_request=shared.UserRoleRequest(
        created_at='2020-06-22T09:37:23.523Z',
        email='Sonia72@hotmail.com',
        id='fcc5469d-4015-4dfa-b962-06bef2b0a3e4',
        invite='quia',
        name='Jack O'Connell Jr.',
        role='perferendis',
        type='eveniet',
        user='excepturi',
    ),
...
res = s.public.post_orgs_org_id_env_types_env_type_users(req)
...
res = s.public.post_orgs_org_id_images_image_id_builds(req)
...
req = operations.PostOrgsOrgIDInvitationsRequest(
    user_invite_request_request=shared.UserInviteRequestRequest(
        email='Rubie_Buckridge@yahoo.com',
        role='sint',
    ),
    org_id='voluptatibus',
)

res = s.public.post_orgs_org_id_invitations(req)
...
req = operations.PostOrgsOrgIDRegistriesRequest(
    registry_request=shared.RegistryRequest(
        ...
        enable_ci=False,
        id='fad2bf7d-67ca-484a-999b-41d612435318',
        registry='quam',
        secrets={
            "cumque": shared.ClusterSecretRequest(
                namespace='delectus',
                secret='ea',
            ),
        },
...
res = s.public.post_orgs_org_id_registries(req)
...
req = operations.PostOrgsOrgIDResourcesAccountsRequest(
    create_resource_account_request_request=shared.CreateResourceAccountRequestRequest(
        ...
        id='d421bd43-d1f0-4cb0-a000-3eb22d9b3a70',
        name='Marshall Gutmann',
        type='deserunt',
    ),
    org_id='iure',
)

res = s.public.post_orgs_org_id_resources_accounts(req)
    ...
    create_resource_definition_request_request=shared.CreateResourceDefinitionRequestRequest(
        criteria=[
            shared.MatchingCriteriaRequest(
                ...
                env_id='cumque',
                env_type='corporis',
                id='7d1fedc2-050d-438d-83ce-185472f9ee69',
                res_id='quasi',
            ),
            shared.MatchingCriteriaRequest(
                app_id='iure',
...
res = s.public.post_orgs_org_id_resources_defs(req)
...
res = s.public.post_orgs_org_id_resources_defs_def_id_criteria(req)
...
res = s.public.post_orgs_org_id_resources_drivers(req)
...
req = operations.PostOrgsOrgIDUsersRequest(
    new_service_user_request=shared.NewServiceUserRequest(
        email='Cathy_Cartwright99@yahoo.com',
        name='Kerry Beer',
        role='aliquam',
    ),
    org_id='autem',
...
res = s.public.post_orgs_org_id_users(req)
...
req = operations.PostOrgsOrgIDWorkloadProfilesRequest(
    workload_profile_request=shared.WorkloadProfileRequest(
        id='7b8a40bc-05fa-4b0d-a50e-df22a94d20ec',
    ),
    org_id='perspiciatis',
)

res = s.public.post_orgs_org_id_workload_profiles(req)
...
res = s.public.post_orgs_org_id_workload_profiles_profile_qid_versions(req)
...
req = operations.PutDeltaRequest(
    delta_request=shared.DeltaRequest(
        ...
        modules=shared.ModuleDeltasRequest(
            add={
                "incidunt": {
                    "deleniti": shared.ControllerRequest(
                        kind='aut',
                        message='nesciunt',
                        pods=[
                            shared.PodStateRequest(
                    ...
                    "alias": shared.ControllerRequest(
                        kind='dignissimos',
                        message='minima',
                        pods=[
                            shared.PodStateRequest(
                    ...
                    "atque": shared.ControllerRequest(
                        kind='dolor',
                        message='optio',
                        pods=[
                            shared.PodStateRequest(
                ...
                "praesentium": {
                    "eveniet": shared.ControllerRequest(
                        kind='est',
                        message='magnam',
                        pods=[
                            shared.PodStateRequest(
                    ...
                    "veniam": shared.ControllerRequest(
                        kind='voluptatem',
                        message='quam',
                        pods=[
                            shared.PodStateRequest(
                ...
                "omnis": {
                    ...
                    "dolores": shared.ControllerRequest(
                        kind='perferendis',
                        message='eum',
                        pods=[
                            shared.PodStateRequest(
...
res = s.public.put_orgs_org_id_apps_app_id_deltas_delta_id_metadata_archived(req)
...
res = s.public.put_orgs_org_id_apps_app_id_deltas_delta_id_metadata_env_id(req)
...
res = s.public.put_orgs_org_id_apps_app_id_deltas_delta_id_metadata_name(req)
...
res = s.public.put_orgs_org_id_apps_app_id_envs_env_id_from_deploy_id(req)
...
res = s.public.put_orgs_org_id_apps_app_id_envs_env_id_rules_rule_id_(req)
...
res = s.public.put_orgs_org_id_apps_app_id_envs_env_id_runtime_paused(req)
...
res = s.public.put_orgs_org_id_apps_app_id_envs_env_id_values_key_(req)
...
res = s.public.put_orgs_org_id_apps_app_id_values_key_(req)
...
res = s.public.put_orgs_org_id_resources_defs_def_id_(req)
...
res = s.public.put_orgs_org_id_resources_drivers_driver_id_(req)
